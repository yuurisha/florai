...
const exportToPDF = () => {
  ...
  // Backfill daily upload-based stats if missing
  useEffect(() => {
  ...
  // Backfill leaf-based stats if missing
  useEffect(() => {
        ...
        >
          ...
          <Tabs defaultValue="map">
            ...
            <TabsContent value="weather" className="mt-4">
                <Card>
                  <CardHeader>
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      ...
                      {/* ✅ Add your controls here (optional but recommended) */}
                  ...
                  <CardContent className="p-0">
                    <div className="h-[70vh] w-full">
                      {/* ⚠️ Replace MapClient mode="user" with your old props version */}
                      <MapClient
                        mode="user"
                        mapId="user-map"
                ...
                {/* ✅ ADD: Your Plant Health table card (your part) */}
                <Card className="mt-6">
                  <CardHeader>
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div>
