...
export default function ReadDiscussionPage() {
  ...
  return (
    <>
      <TopNavBar />
      <div className="bg-[var(--background)] min-h-screen p-4 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <aside className="space-y-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <ul className="space-y-2 text-sm text-green-700">
              <li><a href="#" className="hover:underline">Can we plant anywhere?</a></li>
              <li><a href="#" className="hover:underline">Why we should care about biodiversity</a></li>
              <li><a href="#" className="hover:underline">I find it hard to maintain my plants</a></li>
            </ul>
          </div>
        </aside>
      </div>
